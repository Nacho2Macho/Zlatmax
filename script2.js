...
const select1 = new ItcCustomSelect('#select-1', {
  ...
  options: [['popular', 'По популярности'], ['price', 'По цене'], ['type', 'По типу'], ['category', 'По категории']], // опции
});
...
// if(document.querySelector(".accordion__header")) {
        if(window.innerWidth < 992) {
            document.querySelector(".accordion__item").classList.remove("accordion__item_show");
        }
// }